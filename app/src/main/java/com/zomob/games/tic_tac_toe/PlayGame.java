...
public class PlayGame extends AppCompatActivity {
    ...
    public void playmove(View view) {
        stopPlaying();
        mp= MediaPlayer.create(PlayGame.this,R.raw.leisure_retro_arcade_game_drop_item_tone);
        mp.start();
        ...
        if (gamov == 1) {
            if (win == 1) {
                ...
                MediaPlayer ring= MediaPlayer.create(PlayGame.this,R.raw.clapping);
                ring.start();
                if(flagEndGame==0){
                    player1Win++;
                    counter++;
                ...
                MediaPlayer ring1= MediaPlayer.create(PlayGame.this,R.raw.clapping);
                ring1.start();
                if(flagEndGame==0){
                    player2Win++;
                    counter++;
        ...
        if (gamov == 0) {
            ...
            if (flag == 0) {
                ...
                MediaPlayer ring6= MediaPlayer.create(PlayGame.this,R.raw.missed);
                ring6.start();
                if(flagEndGame==0){
                    counter++;
                    draw++;
