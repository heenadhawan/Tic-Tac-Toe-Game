...
public class PlayGameWithComputer extends AppCompatActivity {
    ...
    public void playmove(View view) {
        MediaPlayer ring7= MediaPlayer.create(PlayGameWithComputer.this,R.raw.leisure_retro_arcade_game_drop_item_tone);
        ring7.start();
        ...
        if (turn == 1 && gamov == 0 && !(playBoard[i][j].getText().toString().equals("X"))
            ...
            if(flipValue==0){
              ...
              //  Log.v("BoardMatrix",String.valueOf(boardMatrix[0][0])+" "+String.valueOf(boardMatrix[0][1])+" "+String.valueOf(boardMatrix[0][2])+" "+String.valueOf(boardMatrix[1][0])+" "+String.valueOf(boardMatrix[1][1])+" "+String.valueOf(boardMatrix[1][2])+" "+String.valueOf(boardMatrix[2][0])+" "+String.valueOf(boardMatrix[2][1])+" "+String.valueOf(boardMatrix[2][2]));
                ...
                playBoard[i][j].setTextColor(Color.GREEN);
                boardMatrix[i][j]=1;
                turn = 2;
                moveNumber++;
                computerPlay();
        ...
        if (gamov == 1) {
            if (win == 1) {
                ...
                MediaPlayer ring= MediaPlayer.create(PlayGameWithComputer.this,R.raw.missed);
                ring.start();
                if(flagEndGame==0){
                    player1Win++;
                    counter++;
                ...
                MediaPlayer ring1= MediaPlayer.create(PlayGameWithComputer.this,R.raw.missed);
                ring1.start();
                if(flagEndGame==0){
                    player2Win++;
                    counter++;
        ...
        if (gamov == 0) {
            ...
            if (flag == 0) {
                ...
                MediaPlayer ring2= MediaPlayer.create(PlayGameWithComputer.this,R.raw.missed);
                ring2.start();
                if(flagEndGame==0){
                    counter++;
                    draw++;
...
//                    counter++;
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.zomob.games.tic_tac_toe/http/host/path")
        );
